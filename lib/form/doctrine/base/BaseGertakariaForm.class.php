...
abstract class BaseGertakariaForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'arduraduna'          => new sfWidgetFormTextarea(),
      ...
      'herritarrena'        => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'arloa_id'            => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Arloa'), 'column' => 'id', 'required' => false)),
      ...
      'arduraduna'          => new sfValidatorString(array('max_length' => 512, 'required' => false)),
      ...
      'herritarrena'        => new sfValidatorInteger(array('required' => false)),
